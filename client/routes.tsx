...
export const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<App />}>
      ...
      />
      <Route
        path="/article/schedule/2/33AHgruaR2x4Jr8DwiFb"
        element={<대회정보components.대회행사일정Link7 />}
      />
      <Route
        path="/article/schedule/2/y7VEOM1T6xlKzttuJijZ"
        element={<대회정보components.대회행사일정Link6 />}
      />
      <Route
        path="/article/schedule/2/SwxVasGjKbmR550uGzfl"
        element={<대회정보components.대회행사일정Link5 />}
      />
      <Route
        path="/article/schedule/2/14aECHOUOJAmUe1O5W37"
        element={<대회정보components.대회행사일정Link4 />}
      />
      <Route
        path="/article/schedule/2/zSrurc48fshLr24J9CHm"
        element={<대회정보components.대회행사일정Link3 />}
      />
      <Route
        path="/article/schedule/2/qAuNkOIAoqwj57WMaebX"
        element={<대회정보components.대회행사일정Link2 />}
      />
      <Route
        path="/article/schedule/2/2LrLZHbSY22AURV7dzyJ"
        element={<대회정보components.대회행사일정Link1 />}
      />
    </Route>
  )
)
